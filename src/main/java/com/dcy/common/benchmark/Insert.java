 ...
 */
public class Insert extends AbstractJavaSamplerClient {
        ...
        try {
            ...
            for (int i = 1; i <= 12; i++) {
                for (int j = (context.getJMeterContext().getThreadNum() * 50) + 1; j <= (context.getJMeterContext().getThreadNum() + 1) * 50; j++) {
                    statement.execute(String.format("insert into sbtest1 (id,k,c,pad) values(%d,24976210,'###########-###########-###########-###########-###########-###########-###########-###########-###########-###########','###########-###########-###########-###########-###########')",j));
                    statement.execute(String.format("insert into sbtest1 (id,k,c,pad) values(%d,24976211,'###########-###########-###########-###########-###########-###########-###########-###########-###########-###########','###########-###########-###########-###########-###########')",j));
                }
